...
from environments.UUV_Mono_Agent.views2d import UUVMonoAgentEnv2dView
from environments.UUV_Mono_Agent.bridge import UUV



#from utils_env import  TSP_Utils
from environments.UUV_Mono_Agent.utils import  UtilsUUVMonoAgentEnv

class UUVMonoAgentEnv(gym.Env) : 
    ...
    def __init__(self,env_config) :
        ...
        self.utils = UtilsUUVMonoAgentEnv()
    ...
    def render(self):
        ...
        ############################################################################################   
            ...
            self.scenario2DView = UUVMonoAgentEnv2dView(self.env_config["implementation"])
